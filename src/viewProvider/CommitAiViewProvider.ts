...
import { CommitAiSourceControl } from '../sourceControl/CommitAiSourceControl';
import { CommitAiSourceControlInputBox } from '../sourceControl/CommitAiSourceControlInputBox';

export class CommitAiViewProvider implements vscode.WebviewViewProvider {

    public static readonly viewType = 'commit-ai.commitSuggestionsView';
    private _commitAi: CommitAi;
    ...
    constructor(
        ...
        this._commitAi = new CommitAi(_context);
        this._suggestions = [];
    ...
    public async getCommitSuggestions() {
        if (this._view) {
